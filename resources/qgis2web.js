...
map.getView().fit([16760203.899664, -4058490.100257, 16918468.675653, -3960778.803777], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Public Open Space and Socioeconomic Status in Greater Sydney</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_PublicOpenSpaceincludingbushlandCoverage_2,
    colName: 'sal_name_2021',
    zoom: 10,
    collapsed: true,
    map: map
});
