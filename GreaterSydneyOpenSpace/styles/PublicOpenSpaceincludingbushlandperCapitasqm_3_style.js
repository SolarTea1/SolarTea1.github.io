...
var style_PublicOpenSpaceincludingbushlandperCapitasqm_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Public Open Spaces per Capita");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 9.912438) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 9.912438 && value <= 30.194692) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.194692 && value <= 63.626596) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 63.626596 && value <= 325.761918) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 325.761918 && value <= 15402266.857143) {
            style = [ new ol.style.Style({
