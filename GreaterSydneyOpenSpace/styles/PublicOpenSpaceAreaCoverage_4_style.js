...
var style_PublicOpenSpaceAreaCoverage_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Public Open Space Non Bush Coverage");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.356780) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.356780 && value <= 2.810074) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.810074 && value <= 5.648209) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.648209 && value <= 10.668622) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.668622 && value <= 85.285221) {
            style = [ new ol.style.Style({
