...
lyr_ESRIGraylight_0.setVisible(true);lyr_WesternParklandCity_1.setVisible(true);lyr_LocalGovernmentArea_2.setVisible(true);lyr_SWGArezonedorreleasedland_3.setVisible(true);lyr_Threatenedecologicalcommunities_4.setVisible(false);lyr_CurrentRoutes_5.setVisible(true);lyr_FutureRoutes_6.setVisible(true);lyr_CurrentStations_7.setVisible(true);lyr_2028CarTripsDay_8.setVisible(false);lyr_2028Population_9.setVisible(false);lyr_ValueUpliftM_10.setVisible(true);lyr_PotentialStations_11.setVisible(true);
